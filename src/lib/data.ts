export const workExperience = [
  {
    title: 'Phocas',
    slogan: 'BI and FP&A together for smarter decisions',
    img: '/assets/images/mixr.png',
    color: '#07b8d6',
    demo: 'https://www.phocassoftware.com/',
    slug: 'phocas',
    description:
    ...
    design: {
      ...
      iframe:
        'https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2F4EO0OWcXHlK6HFy7nigNrt%2FUntitled%3Fnode-id%3D1%253A1574',
    },
    tools: [
      {
        name: 'React',
...
export const freelancing = [
  ...
  },
  {
    ...
    design: {
      ...
      iframe:
        'https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2FevsnG3OIVbBkKs9I50GNM4%2FMotory-Design-Process%3Fnode-id%3D0%253A1',
    },
    tools: [
      {
        name: 'React',
...
export const careerHistory: ICareerHistory[] = [
  {
    ...
    marketingImgs: [
      // '/assets/images/mkt/proworkflow/File2.png',
      // '/assets/images/mkt/proworkflow/File3.png',
      // '/assets/images/mkt/proworkflow/File4.png',
      // '/assets/images/mkt/proworkflow/File5.png',
      // '/assets/images/mkt/proworkflow/File6.png',
      // '/assets/images/mkt/proworkflow/File7.png',
  ...
  //   description:
  //     "As a team member, I assumed responsibility for the creation of joinery products through 3D modelling, engineering, and CNC programming. My role involved the development of new products to expand the company's catalogue and the upkeep of existing items. To enhance productivity, I introduced automation through scripting, resulting in error reduction. Additionally, I improved the clarity of reports intended for designers, clients, suppliers, and manufacturers.",
  ...
  //   description:
  //     "Starting as a product designer, I later took charge of the development department, overseeing a team of 8 designers and programmers for an interior design software platform for more than 200 clients. I provided technical support to the sales team for scope definition and delivery estimation. As a manager, I skillfully handled projects, guaranteeing that deadlines were met promptly. Additionally, I supported the team with technical challenges and managed the project using the waterfall approach.",
