export const projects = [
    ...
    },
    {
        ...
        slug: 'countries-rank',
        description: 'World Ranks is a web application that lists countries and provide information such as: capital, subregion, language, currency, native name, Gini and neighbours countries. The front-end was build using Next.js using external API for data.',
        tools: [
            {
                name: 'React',
                icon: '/assets/icons/react.png'
...

    {
        ...
        slug: 'happy',
        description: 'This application was made during the Next Level Week promoted by Rocketseat. This app will show orphanages nearby. You can also create an account and add orphanages that wasnt listed. This registration will be waiting for the administrator to approve.',
        tools: [
            {
                name: 'React',
                icon: '/assets/icons/react.png'
    ...
    },
    {
        ...
        slug: 'ecollect',
        description: 'This application was made during the Next Level Week promoted by Rocketseat. The idea to create an ecological application came up inspired by the World Environment Day. The goal is to encourage awareness and action for the protection of the environment.',
        tools: [
            {
                name: 'React',
                icon: '/assets/icons/react.png'
...

    {
        ...
        slug: 'letmeask',
        description: 'This application was made during the Next Level Week - Together promoted by Rocketseat. The app was made to help people to combine questions organized by room. Inside each room, the admin can: highlight, answer and delete questions made in real-time!',
        tools: [
            {
                name: 'React',
                icon: '/assets/icons/react.png'
    ...
    },
    {
        ...
        slug: 'proffy',
        description: 'Proffy is a web application and mobile to help people find teachers and connect them. This application was made during the Next Level Week 2 promoted by Rocketseat.',
        tools: [
            {
                name: 'React',
                icon: '/assets/icons/react.png'
    ...
    },
    {
        ...
        slug: 'movies',
        description: 'Movie App is an online library to help people find your favorite movie. This application was made to exercise the connection between React and an outside API promoted by TheMovieDB.',
        tools: [
            {
                name: 'React',
                icon: '/assets/icons/react.png'
    ...
    },
    {
        ...
        slug: 'pokedex',
        description: 'Pokedex App is an online library to help people find your favorite Pokemon. This application was made to exercise the connection between React and an outside API promoted by PokéAPI.',
        tools: [
            {
                name: 'React',
                icon: '/assets/icons/react.png'
