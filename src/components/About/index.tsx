    ...
    >
      ...
      <main>
        ...
        <motion.p variants={fadeInUp}>
          Hi, I’m <strong>Daniel Pisati</strong> — a designer and developer
          based in Christchurch, New Zealand 🌏. I’m passionate about user
          interfaces, 3D illustration, animation, and frontend development. I
          love building products that make a real impact, always with a focus on
          intuitive, beautiful user experiences. I’m constantly learning, always
          open to sharing ideas — and if you feel like chatting, hit me up on
          social media 😉
        </motion.p>
